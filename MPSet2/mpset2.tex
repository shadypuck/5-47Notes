...
\begin{itemize}
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.5\linewidth]{MPSet2Q5.png}
    ...
    \includepdf{ExtFiles/MPSet2Q5Full.pdf}
    \item We now begin Problem 2.
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.65\linewidth]{MPSet2Q2.png}
    ...
    \includepdf{ExtFiles/MPSet2Q2Full.pdf}
...
\begin{itemize}
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.4\linewidth]{MPSet2Q3.png}
    ...
    \end{itemize}
    \includepdf{ExtFiles/MPSet2Q3Exo.pdf}
    \item We now begin discussing Problem 1.
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.6\linewidth]{MPSet2Q1.png}
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.8\linewidth]{MPSet2Q1S.JPG}
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.45\linewidth]{MPSet2Q4.png}
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.7\linewidth]{MPSet2Q4S.JPG}
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.45\linewidth]{MPSet2Q6.png}
    ...
    \begin{figure}[h!]
        \centering
        \includegraphics[width=0.8\linewidth]{MPSet2Q6S.JPG}
